let tmi,dotenv;_c7f‍.w("tmi.js",[["default",["tmi"],function(v){tmi=v}]]);_c7f‍.w("dotenv",[["default",["dotenv"],function(v){dotenv=v}]]);
...
function onMessageHandler (target, context, msg, self) {
	...
	if (commandName == '!help') {
		client.say(target, `Bdo Specific Commands: `);
		client.say(target, bdoCommands);
		client.say(target, `League Specific Commands: `);
		client.say(target, leagueCommands);
		client.say(target, `Other Commands: `)
